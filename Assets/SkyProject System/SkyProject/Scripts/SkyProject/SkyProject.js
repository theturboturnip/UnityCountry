...
function Awake(){
GeneralSettings.mainCamera=Camera.current;
Helpers();
...
//CAMERA CODE
	...
	cameraOfSky.camera.fieldOfView = 90;//GeneralSettings.mainCamera.camera.fieldOfView;
...
if(GeneralSettings.mainCamera)
GeneralSettings.mainCamera.backgroundColor=RenderSettings.fogColor;
else
GeneralSettings.mainCamera=Camera.current;
Fades();
SplashUpdate();
